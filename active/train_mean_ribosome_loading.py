...
class TrainingArguments(transformers.TrainingArguments):
    ...
    evaluation_strategy: str = field(default="steps")  # CHANGE: was fine in original, kept consistent
...
def _get_pool_predictions_mc(trainer, pool_dataset, data_collator, num_mc_samples: int):
    ...
    Returns array of shape (num_mc_samples, N).
    """
