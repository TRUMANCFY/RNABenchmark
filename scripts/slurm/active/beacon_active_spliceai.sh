#!/usr/bin/env bash
# submit_beacon_active_learning.sh
# Submit active learning experiments for BEACON on SpliceAI
set -euo pipefail
...
for entry in "${MODELS[@]}"; do
  ...
  for AL_STRATEGY in "${AL_STRATEGIES[@]}"; do
    ...
    JOB_NAME="al_${MODEL_NAME}_SpliceAI_${AL_STRATEGY}"
...
\$EXEC_PREFIX active/train_spliceai.py \
