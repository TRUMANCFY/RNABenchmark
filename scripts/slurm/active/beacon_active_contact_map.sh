#!/usr/bin/env bash
# submit_beacon_active_learning_contact_map.sh
# Submit active learning experiments for BEACON on Contact Map
set -euo pipefail
...
for entry in "${MODELS[@]}"; do
  ...
  for AL_STRATEGY in "${AL_STRATEGIES[@]}"; do
    ...
    JOB_NAME="al_${MODEL_NAME}_ContactMap_${AL_STRATEGY}"
...
\$EXEC_PREFIX active/train_contact_map.py \
